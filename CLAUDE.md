...
Next up per the plan: Semana 5, Dia 21 (Testes Automatizados - Backend) — this is also where an automated test framework (Vitest per the plan's references) would first get set up, still pending from Dia 15.
