        ...
        {segments.map((segment, index) =>
          segment.type === 'word' ? (
            <span
              ...
              className={`rounded px-1 py-1 cursor-pointer touch-manipulation transition-colors hover:bg-slate-200 ${
                segment.word.id === activeWordId ? 'bg-yellow-200 font-semibold' : ''
              }`}
            >
              {segment.text}
            </span>
